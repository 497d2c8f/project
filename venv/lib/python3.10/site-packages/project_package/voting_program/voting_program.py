...
def get_l_vp_sign_pk():
	...
	if input('\nВ голосовании может участвовать любой желающий?\n\n1. Да\n2. Нет\n\nВыберите и нажмите Enter: ') == '2':
		keys_public_files_dir = format_path(input('\nПеретащите сюда папку с открытыми ключами участников голосования, допущенных до голосования, и нажмите Enter: '))
...
if option_1 == AGENCY_MODE:
	...
	option_2 = input('\n0. Выход\n1. Создать файл голосования\n2. Обработать финальный этап голосования\n\nВыберите и нажмите Enter: ')
	...
	if option_2 == '2':
		...
		voting = read_file(voting_filepath)['voting']
		msg_wa_filepath = format_path(input('\nПеретащите сюда файл "msg_wa__*" и нажмите Enter: '))
		...
		msg_voting_summary_filepath = os.path.join(VOTINGS_WD, a_data['v'].get_v_id()[0:8].hex(), f'msg_voting_summary__{a_data["v"].get_v_id()[0:8].hex()}_{keys_file_data["sign_pk"][0:8].hex()}')
